...
# Upewnij się, że to jest Twój model DuelingMLP, a nie QNetwork
from engine.model_dueling import DuelingMLP  # Plik z definicją PyTorch DuelingMLP
...
runner_model = DuelingMLP(state_dim=runner_state_dim, action_dim=runner_action_dim)
blocker_model = DuelingMLP(state_dim=blocker_state_dim, action_dim=blocker_action_dim)
...
write_codingame_bot(
    "codingame/codingame_duelingDQN_template.py",
    output_file,
    uni_r,
    uni_b,
    runner_state_dim,
